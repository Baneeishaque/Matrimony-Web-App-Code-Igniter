    ...
    <div class="container-fluid default-container">
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-12 col-12 prof-pad-zero user-side-wrap mx-wdth-22">
                <div class="  row-prf">
                    <div class="rh">
                        <img src="<?php echo base_url(); ?>assets/uploads/<?php echo $mydata[0]->img_name; ?>"
                             class="img-responsive usr-prf-img">
                    </div>
                ...
                <div class="menu-row">
                    <ul class="sidenav">
                        <li><a href=""> <i class="fas fa-list-ul lst"></i>&nbsp; Add Photo<img
                                        src="<?php echo base_url(); ?>assets/images/arw.png" class="caret-dwn wdth-arw"></a>
                        </li>
                        <li><a href=""><i class="fas fa-list-ul lst"></i>&nbsp; Edit Your Profile<img
                                        src="<?php echo base_url(); ?>assets/images/arw.png" class="caret-dwn wdth-arw"></a>
                        </li>
                        <li><a href=""><i class="fas fa-list-ul lst"></i>&nbsp; Edit Partner Pregrences<img
                                        src="<?php echo base_url(); ?>assets/images/arw.png" class="caret-dwn wdth-arw"></a>
                        </li>
                        <li><a href=""><i class="fas fa-list-ul lst"></i>&nbsp; Settings<img
                                        src="<?php echo base_url(); ?>assets/images/arw.png" class="caret-dwn wdth-arw"></a>
                        </li>
                        <li><a href=""><i class="fas fa-list-ul lst"></i>&nbsp; Wedding Services<img
                                        src="<?php echo base_url(); ?>assets/images/arw.png" class="caret-dwn wdth-arw"></a>
                        </li>
                        <li><a href=""> <i class="fas fa-list-ul lst"></i>&nbsp; Discover Matches<img
                                        src="<?php echo base_url(); ?>assets/images/arw.png" class="caret-dwn wdth-arw"></a>
                        </li>
                        <li>
                            <a class="accordion-toggle toggle-switch collapsed" data-toggle="collapse" href="#submenu-1"
                               aria-expanded="false">
                            ...
                            <ul id="submenu-1" class="panel-collapse submnu panel-switch collapse" role="menu"
                                aria-expanded="false" style="height: 10px;">
                        ...
                        <li>
                            <a class="accordion-toggle toggle-switch collapsed" data-toggle="collapse" href="#submenu-4"
                               aria-expanded="false">
                                <span class="sidebar-icon"><i class="fas fa-list-ul lst"></i>&nbsp;</span>
                                <span class="sidebar-title">Interests</span>
                                <img src="<?php echo base_url(); ?>assets/images/down.png" class="caret-dwn wdth-arw">
                            </a>
                            <ul id="submenu-4" class="panel-collapse submnu panel-switch collapse" role="menu"
                                aria-expanded="false" style="height: 10px;">
                        ...
                        <li>
                            <a class="accordion-toggle toggle-switch collapsed" data-toggle="collapse" href="#submenu-6"
                               aria-expanded="false">
                                <span class="sidebar-icon"><i class="fas fa-list-ul lst"></i>&nbsp;</span>
                                <span class="sidebar-title">Profile Visits</span>
                                <img src="<?php echo base_url(); ?>assets/images/down.png" class="caret-dwn wdth-arw">
                            </a>
                            <ul id="submenu-6" class="panel-collapse submnu panel-switch collapse" role="menu"
                                aria-expanded="false" style="height: 10px;">
                        ...
                        <li>
                            <a class="accordion-toggle toggle-switch" data-toggle="collapse" href="#submenu-7"
                               aria-expanded="true">
                                <span class="sidebar-icon"><i class="fas fa-list-ul lst"></i>&nbsp; </span>
                                <span class="sidebar-title"> Contact View</span>
                                <img src="<?php echo base_url(); ?>assets/images/down.png" class="caret-dwn wdth-arw">
                            </a>
                            <ul id="submenu-7" class="panel-collapse submnu panel-switch collapse in" role="menu"
                        ...
                        <li>
                            <a class="accordion-toggle toggle-switch collapsed" data-toggle="collapse" href="#submenu-5"
                               aria-expanded="false">
                                <span class="sidebar-icon"><i class="fas fa-list-ul lst"></i>&nbsp;</span>
                                <span class="sidebar-title">Short List</span>
                                <img src="<?php echo base_url(); ?>assets/images/down.png" class="caret-dwn wdth-arw">
                            </a>
                            <ul id="submenu-5" class="panel-collapse submnu panel-switch collapse" role="menu"
                                aria-expanded="false" style="height: 10px;">
                        ...
                        <li>
                            <a class="accordion-toggle toggle-switch collapsed" data-toggle="collapse" href="#submenu-3"
                               aria-expanded="false">
                                <span class="sidebar-icon"><i class="fas fa-list-ul lst"></i>&nbsp;</span>
                                <span class="sidebar-title">Requests</span>
                                <img src="<?php echo base_url(); ?>assets/images/down.png" class="caret-dwn wdth-arw">
                            </a>
                            <ul id="submenu-3" class="panel-collapse submnu panel-switch collapse" role="menu"
                                aria-expanded="false" style="height: 10px;">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-12 mx-wdth-56">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="cntr-usr-wraps-2 row">
                                ...
                                <div class="col-md-10 col-9">
                                    ...
                                    <a href="#" class="manage-btn"> <i class="fas fa-long-arrow-alt-right"></i>&nbsp;
                                        Manage your partner prefrences </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="latest-updts-wrap">
                    <h2 class="user-hed-1"><img src="<?php echo base_url(); ?>assets/images/LOKK.png"
                                                class="img-fluid lve-img">&nbsp; LATEST UPDATES </h2>
                    <div class="row  as">
                        <div class="col-lg-2 width-25">
                            <div class="up-img">
                                <img src="<?php echo base_url(); ?>assets/images/usr-1.jpg" class="img-fluid">
                                <span>25</span>
                            </div>
                        ...
                        <div class="col-lg-2 width-25">
                            <div class="up-img">
                                <img src="<?php echo base_url(); ?>assets/images/up-2.jpg" class="img-fluid">
                                <span>25</span>
                            </div>
                        ...
                        <div class="col-lg-2 width-25">
                            <div class="up-img">
                                <img src="<?php echo base_url(); ?>assets/images/up-3.jpg" class="img-fluid">
                                <span>25</span>
                            </div>
                        ...
                        <div class="col-lg-2 width-25">
                            <div class="up-img">
                                <img src="<?php echo base_url(); ?>assets/images/up-4.jpg"
                                     class="img-fluid"><span>25</span>
                            </div>
                            <h5 class="latest-up-subhed"><a href="#">Members looking for you</a></h5>
                        </div>
                        <div class="col-lg-2 width-25">
                            <div class="up-img">
                                <img src="<?php echo base_url(); ?>assets/images/up-5.jpg"
                                     class="img-fluid"><span>25</span>
                            </div>
                        ...
                        <div class="col-lg-2 width-25">
                            <div class="up-img">
                                <img src="<?php echo base_url(); ?>assets/images/up-6.jpg"
                                     class="img-fluid"><span>25</span>
                            </div>
                ...
                <div class="new-mchs-foru-wrp">
                    <h2 class="user-hed-1"><img src="<?php echo base_url(); ?>assets/images/lve.jpg"
                                                class="img-fluid lve-img">&nbsp; NEW MATCHES FOR YOU </h2>
                    ...
                    <div class="nw-match-row row asa1 pdn-12">
                        <div class="col-lg-12 col-md-12 col-12  pad-9">
                            <div class="mch-innr-wrp">
                                ...
                                <button class=" sent-interest-btn"><i class="fas fa-heart clr-love"></i>&nbsp; Sent
                                    Interest
                                </button>
                            </div>
                        </div>
                ...
                <div class="new-mchs-foru-wrp">
                    <h2 class="user-hed-1"><img src="<?php echo base_url(); ?>assets/images/lve.jpg"
                                                class="img-fluid lve-img"> &nbsp;WHO VIEWED YOUR PROFILE </h2>
                    <a href="" class="view-all-btn">View All</a>
                    <div class="nw-match-row row asa1 pdn-12">
                        <div class="col-lg-12 col-md-12 col-12 pad-9">
                            <div class="mch-innr-wrp">
                ...
                <div class="new-mchs-foru-wrp " style="margin-bottom: 0;">
                    <h2 class="user-hed-1"><img src="<?php echo base_url(); ?>assets/images/lve.jpg"
                                                class="img-fluid lve-img"> PARTNER PREFERENCES </h2>
                    <a href="" class="view-all-btn">View All</a>
                        ...
                        <div class="col-lg-12 col-md-12 col-12 pad-px">
                            <div class="mch-innr-wrp rews">
                                ...
                                <div class="col-md-5 col-12 pad-left-0 ">
                                    ...
                                    <button class=" sent-interest-btn sent-interest-btn-2"><i
                                                class="fas fa-heart clr-love"></i>&nbsp; Sent Interest
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="row usr-no-arw">
                        <div class="new-mchs-foru-wrp col-md-6 col-12 mrg-1">
                            <h2 class="user-hed-1 last-hed"><img src="<?php echo base_url(); ?>assets/images/lve.jpg"
                                                                 class="img-fluid lve-img"> WHO VIEWED YOUR CONTACT
                            </h2>
                            <div class="nw-match-row row asa2">
                                <div class="col-lg-12 col-md-12 col-12 pad-7">
                                    <div class="mch-innr-wrp rews">
                                        <div class="col-md-7 col-12 pad-left-0">
                                            <img src="<?php echo base_url(); ?>assets/images/img-1.jpg"
                                                 class="img-fluid">
                                        </div>
                                        <div class="col-md-5 col-12 pad-left-0 ">
                                            <a href="#">
                        ...
                        <div class="new-mchs-foru-wrp col-md-6 col-12 mrg-2">
                            <h2 class="user-hed-1 last-hed"><img src="<?php echo base_url(); ?>assets/images/lve.jpg"
                                                                 class="img-fluid lve-img"> WHO SHORTLISTED YOUR PROFILE
                            </h2>
                            <div class="nw-match-row row asa2">
                                <div class="col-lg-12 col-md-12 col-12 pad-7">
                                    <div class="mch-innr-wrp rews">
            ...
            <div class="col-lg-2 col-md-2 col-sm-12 col-12 prof-pad-zero mx-wdth-22">
                ...
                <span class="progress-left">
                    ...
                    <p class="prgrs-p">Fill in your details to maximize your chances of getting responses to your
                        profile.</p>
