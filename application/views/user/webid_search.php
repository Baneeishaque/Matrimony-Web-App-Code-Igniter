...
<div class="tabs">
  <div class="tab-button-outer">
    <ul id="tab-button">
      <li><a href="<?php echo base_url(); ?>index.php/user/quicksearch">Quick Search</a></li>
      ...
      <li class="active"><a href="<?php echo base_url(); ?>index.php/user/webidsearch">Web Id Search</a></li>
