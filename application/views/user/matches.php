              ...
              <div id="collapseOne" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body">
                  <ul class="filtr-innr-ul">
                    <a href="#"><li>New Matches</li></a>
                    <a href="#"><li >Partner Preferences</li></a>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div id="collapseTwo" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="headingTwo">
                <div class="panel-body">
                 <div class="custom-control custom-radio">
                  ...
                  <label class="custom-control-label cst-ser-res-label" for="customRadio1">Only Show with Photo</label>
                </div>
                <div class="custom-control custom-radio">
                  <input type="radio" id="customRadio2" name="customRadio" class="custom-control-input">
                  <label class="custom-control-label cst-ser-res-label" for="customRadio2">Don't Show Already Viewed</label>
                </div>
  ...
  <div class="panel-body">
   <select class="js-select2 " multiple="multiple" placeholder="Religion">
    ...
    foreach($marital_status as $row){ ?>
      <option value="<?php echo $row->marital_status_id; ?>" data-badge=""><?php echo $row->marital_status; ?></option>
    <?php  }?>
  </select>
  ...
  <div id="collapse6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading6">
    <div class="panel-body">
      ...
      foreach($religion as $row){ ?>
        <option value="<?php echo $row->religion_id; ?>" data-badge=""><?php echo $row->religion; ?></option>
      <?php  }?>
    </select>
  ...
  <div class="panel-body">
   <select class="js-select2 " multiple="multiple" placeholder="Religion">
    ...
    foreach($education as $row){ ?>
      <option value="<?php echo $row->education_id; ?>" data-badge=""><?php echo $row->education; ?></option>
    <?php  }?>
  </select>
  ...
  <div class="panel-body">
   <select class="js-select2 " multiple="multiple" placeholder="Religion">
    ...
    foreach($job_category as $row){ ?>
      <option value="<?php echo $row->job_cat_id; ?>" data-badge=""><?php echo $row->job_cat; ?></option>
    <?php  }?>
  </select>
  ...
  <div class="panel-body">
   <select class="js-select2 " multiple="multiple" placeholder="Religion">
    ...
    foreach($states as $row){ ?>
      <option value="<?php echo $row->id; ?>" data-badge=""><?php echo $row->state; ?></option>
    <?php  }?>
  </select>
    ...
    <div class="panel-body">
     <select class="js-select2 " multiple="multiple" placeholder="Religion">
      ...
      foreach($complexion as $row){ ?>
        <option value="<?php echo $row->complexion_id; ?>" data-badge=""><?php echo $row->complexion; ?></option>
      <?php  }?>
    </select>
 ...
 <div id="collapse12" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading12">
  <div class="panel-body">
   <select class="js-select2 " multiple="multiple" placeholder="Religion">
    <?php 
      foreach($star as $row){ ?>
        <option value="<?php echo $row->star_id; ?>" data-badge=""><?php echo $row->star; ?></option>
      <?php  }?>
  </select>
  ...
  <div class="panel-body">
   <select class="js-select2 " multiple="multiple" placeholder="Religion">
    ...
    foreach($jathakam as $row){ ?>
      <option value="<?php echo $row->jathakam_id; ?>" data-badge=""><?php echo $row->typeof_jathakam; ?></option>
    <?php  }?>
  </select>
  ...
  <div class="panel-body">
   <select class="js-select2 " multiple="multiple" placeholder="Religion">
    ...
    foreach($languages as $row){ ?>
      <option value="<?php echo $row->id; ?>" data-badge=""><?php echo $row->name; ?></option>
    <?php  }?>
  </select>
  ...
  <div class="panel-body">
   <select class="js-select2 " multiple="multiple" placeholder="Religion">
    ...
    foreach($physical_status as $row){ ?>
      <option value="<?php echo $row->physical_status_id; ?>" data-badge=""><?php echo $row->physical_status; ?></option>
    <?php  }?>
  </select>
  ...
  <div class="panel-body">
   <select class="js-select2 " multiple="multiple" placeholder="Religion">
    ...
    foreach($income as $row){ ?>
      <option value="<?php echo $row->income_id; ?>" data-badge=""><?php echo $row->income; ?></option>
    <?php  }?>
  </select>
    ...
    <div class="panel-body">
     <select class="js-select2 " multiple="multiple" placeholder="Religion">
      ...
      foreach($family_status as $row){ ?>
        <option value="<?php echo $row->family_status_id; ?>" data-badge=""><?php echo $row->family_status; ?></option>
      <?php  }?>
    </select>
...
<div class="col-lg-8 col-md-8 col-sm-12 col-12 mx-wdth-56">
  <h2 class="ser-res-foun"><img src="<?php echo base_url(); ?>assets/images/serch.png" class="img-fluid"> &nbsp;50 Search Results Found! &nbsp;<i class="fas fa-level-down-alt"></i></h2>
  ...
  <div class="search-res-wrap"> 
    <div class="row">
      <div class="col-lg-3 col-md-3 col-sm-3 col-12 pd-ser-ryt-0">
        <img src="<?php echo base_url(); ?>assets/images/img-1.jpg" class="img-fluid ser-res-img">
      </div>
      <div class="col-lg-9 col-md-9 col-sm-9 col-12">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-12 dis-flx">
            <h3 class="prem-mem"><i class="fas fa-crown comn-icon"></i>&nbsp; Premium Member</h3> 
            <a href="#"><h6 class="chaticon">Chat&nbsp; <i class="fas fa-comments"></i></h6> </a>
          </div>
        </div>

        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-12 dis-flx"> <i class="fas fa-quote-left icn-qutes icn-qute"></i> <!-- <i class="fas fa-quote-left "></i> --> 
            <p class="moree ser-res-para">Irin is My daughter and His Education Qualification is Other Masters Degree in Engineering / Computers and His job Status is  Working Abroad - European.We are Residing @ THRISSUR District , Kerala</span>  
            </div>  
          </div>
          <hr>
          <div class="row rw-bordr">
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
              <h6 class="ser-res-details"><i class="far fa-user-circle icn-res"></i>&nbsp; 27 Yrs | 157cm-5 ft 2 in</h6>

            </div>  
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
              <h6 class="ser-res-details"><i class="fas fa-map-marker-alt icn-res loct-ser-res"></i>&nbsp; Eranakulam, Kerala, India</h6>
          ...
          <div class="row rw-bordr">
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
              <h6 class="ser-res-details"><i class="fas fa-book-open icn-res" style="font-size: 11px;"></i>&nbsp; Christian, Catholic</h6>

            </div>  
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
              <h6 class="ser-res-details"><i class="fab fa-fort-awesome-alt icn-res"></i>&nbsp; Syrian</h6>
          ...
          <div class="row rw-bordr">
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
              <h6 class="ser-res-details"><i class="fas fa-graduation-cap icn-res"></i>&nbsp; Btech</h6>

            </div>  
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
              <h6 class="ser-res-details"><i class="fas fa-suitcase icn-res"></i>&nbsp; Software Developer</h6>
