 ...
 <nav class="navbar navbar-expand-md home-nav">
    <div class="container-fluid">
      ...
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"><span class="navbar-toggler-icon">  <i class="fas fa-bars" style="color:#f50767; font-size:28px;"></i></span></span>
      </button>
      ...
      <section class="sli-hom-sec">
         <div class="container-fluid">
         <div class="row  banner-rw">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 home-banner-wrapper home-sli-pad">
               <!-- Images from Unsplash -->
               <div class="slider-container">
                  <div class="slide" style="background-image: url('<?php echo base_url(); ?>assets/images/Slider 2.jpg')"></div>
                  <div class="slide" style="background-image: url('<?php echo base_url(); ?>assets/images/Slider 4.jpg')"></div>
                  <div class="slide" style="background-image: url('<?php echo base_url(); ?>assets/images/Slider 5.jpg')"></div>
