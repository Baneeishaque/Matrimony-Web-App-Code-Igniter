...
<section class="prv-sec">
 ...
 <div class="col-lg-9 col-md-9 col-sm-12 col-12">
  <h2 class="malyali-hed"><img src="<?php echo base_url(); ?>assets/images/lock.png" class="img-fluid lock-img"> &nbsp;Privacy Policy</h2>
...
<p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.</p>
      ...
      <div class="col-lg-3 col-md-3 col-sm-12 col-12 privac-pol">
       
 <div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front ">
    <img src="<?php echo base_url(); ?>assets/images/sucess-stories.jpg" class="img-fluid">
    </div>
  ...
  <h5> Your satisfaction is our happiness!!</h5>
  <a href="#" class="priv-btn"> Go To Success Stories</a>
</div>
...
<a href="#"class="royl-reg">Register Now</a>
  ...
  <img src="<?php echo base_url(); ?>assets/images/add.jpg" class="img-fluid ad-img">
